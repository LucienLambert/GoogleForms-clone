...
export class LoginComponent implements OnInit, AfterViewInit {
     ...
     * à l'attribut 'nativeElement'. Le paramètre 'email' que l'on passe ici correspond au tag
     * que l'on a associé à cet élément dans le template HTML sous la forme de #<tag>. Ici par
     * exemple <input #email id="email"...>.
     *
     ...
     * C'est le bon endroit pour mettre le focus dans le champ 'email'.
     */
    ngAfterViewInit() {
        /**
